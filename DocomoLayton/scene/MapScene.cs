...
public class MapScene : IScene
{
    ...
    public void Setup(GameContext gameContext)
    {
        ...
        if (l.LoadFiles(var3))
        {
            ...
            f = game.Resources.KeyboardResource.Create(l.GetLoadedImage("font7.gif"), 9, 12, 10, 0);
            d[0].AddChild(f, 209 - d[0].GetWidth() / 2, 221);
            ((game.Resources.KeyboardResource)f).b1(0);
            ((game.Resources.KeyboardResource)f).a1(gameContext.SaveData.GetQuestionsSolvedCount().ToString());
