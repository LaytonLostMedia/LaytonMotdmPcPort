    ...
    public void Setup(GameContext gameContext)
    {
        ...
        if ((var14 = gameContext.RoomData.GetPotCount()) > 0)
        {
            ...
            for (var24 = 0; var24 < f.Length; ++var24)
            {
                ...
                f[var24] = game.Resources.KeyboardResource.Create(gameContext.ScriptResourceFileManager.GetLoadedImage("save_number.gif"), 7, 10, 10, Helper.ToStringPad(var19, 3));
                if (var24 < 4)
                {
