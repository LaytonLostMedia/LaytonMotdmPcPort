...
public abstract class ControlScene : IScene
{
    ...
    public void Setup(GameContext GameContext)
    {
        ...
        j1();
        k1();
        if (GameContext.RoomData.GetBitFlag(99))
        {
            this.L.b1("return");
            this.O.b1("question");
            this.O.b1("answer");
        ...
        switch (this.G)
        {
            case 0:
                if (var2._transitionState == 3)
                {
                    ...
                    if (var1.RoomData.GetBitFlag(99))
                    {
                        this.J.g1();
                        this.d1();
                        this.e1();
    ...
    private void g1(GameContext var1)
    {
        ...
        else
        {
            AudioManager.StopSound(0);
            this.c1();
            AudioManager.PlaySound(1, this.n[9], 100);
        }
