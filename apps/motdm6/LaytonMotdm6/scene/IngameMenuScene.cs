...
public class IngameMenuScene : IScene
{
    ...
    public void Setup(GameContext GameContext)
    {
        ...
        JavaString[] var3 = new JavaString[] { "bag.jpg", "i_bag_mono3.gif", "i_bag_suiri0.gif", "i_bag_suiri1.gif", "i_bag_suiri2.gif", "i_bag_mono0.gif", "i_bag_mono1.gif", "i_bag_mono2.gif", "i_bag80.gif", "i_bag81.gif", "i_bag82.gif", "i_bag40.gif", "i_bag41.gif", "i_bag42.gif", "i_bag_mono4.gif", "i_bag_mono5.gif", "i_bag_mono6.gif", "new_spr.gif", "i_bag_close.gif", "i_bag_return.gif", "i_bag_mono7.gif", "i_bag_mono8.gif", "i_bag_mono9.gif" };
        if (!d.LoadFiles(var3))
        {
            n = 4;
            a = 99;
        ...
        else
        {
            ...
            if (GameContext.SaveData.B1() == 1)
            {
                ((ImageResource)this.e2[14]).SetImage(this.d.GetLoadedImage("i_bag_mono7.gif"));
                ((ImageResource)this.e2[15]).SetImage(this.d.GetLoadedImage("i_bag_mono8.gif"));
                ((ImageResource)this.e2[16]).SetImage(this.d.GetLoadedImage("i_bag_mono9.gif"));
            }
