...
public class MinigameScene : IScene
{
    ...
    public void Setup(GameContext var1)
    {
        ...
        if (this.d.LoadFiles(var4))
        {
            ...
            for (int var9 = 0; var9 < var3; ++var9)
            {
                ...
                this.c[var9].c1(a1(this.C["[" + (var9 + 1) + "]"], 0));
                this.c[var9].b1(a1(this.C["[" + (var9 + 1) + "]"], 1));
                if (this.c[var9].e1() == 1)
                {
                    this.c[var9].a1(this.d.GetLoadedImage("swords.gif"));
                }
                else if (this.c[var9].e1() == 2)
                {
                    this.c[var9].a1(this.d.GetLoadedImage("ibag.gif"));
                }
                else if (this.c[var9].e1() == 3)
                {
                    this.c[var9].a1(this.d.GetLoadedImage("book.gif"));
                }
                else if (this.c[var9].e1() == 4)
                {
                    this.c[var9].a1(this.d.GetLoadedImage("swords_saya.gif"));
                }
                else if (this.c[var9].e1() == 5)
                {
                    this.c[var9].a1(this.d.GetLoadedImage("book2.gif"));
                }
                else if (this.c[var9].e1() == 6)
                {
                    this.c[var9].a1(this.d.GetLoadedImage("book3.gif"));
                }

                this.c[var9].a1(182 - (var9 + 1) * MiniGameInternal.a1(this.c[var9]).GetHeight());
                this.e[0].AddChild(MiniGameInternal.a1(this.c[var9]), this.c[var9].d1(), this.c[var9].c1());
            }
            ...
            int[] var10 = new int[] { 0, 1, 2, 3, 4 };
            this.e[36] = ImageResource.Create(this.d.GetLoadedImage("mg_failed.gif"));
            this.e[0].AddChild(this.e[36]);
            ((ImageResource)this.e[36]).a1(0, 0, this.e[36].GetWidth() / 3, this.e[36].GetHeight() - this.e[36].GetHeight() / 2, var10);
    ...
    private void f1(GameContext var1)
    {
        ...
        {
            if (var1.SaveData.l1(var5) != 1 && var1.SaveData.l1(var5) != 2 && var1.SaveData.l1(var5) != 3 && var1.SaveData.l1(var5) != 4)
            {
                if (var1.SaveData.l1(var5) == 5)
                {
                    ++var3;
                }
                else if (var1.SaveData.l1(var5) == 6)
                {
                    ++var4;
                }
            }
