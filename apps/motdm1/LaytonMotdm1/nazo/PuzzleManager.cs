...
public class PuzzleManager
{
    ...
    public static IScene GetSolutionInputControl(ScreenResource paramc, byte[] nazoData, byte[] resourceData, int paramInt)
    {
        ...
        if (c2.Load(paramc, resourceData))
        {
            ...
            {
                case 1:
                    var6 = ButtonPuzzleScene.GetInstance();
                    break;
                case 2:
                    var6 = SwitchPuzzleScene.Create();
                    break;
                case 3:
                    var6 = SelectionPuzzleScene.Create();
                    break;
                case 4:
                    var6 = LinePuzzleScene.Create();
                    break;
                case 5:
                    var6 = KeyboardPuzzleScene.Create();
                    break;
            }
          ((PuzzleScene)var6)?.a1(c1, c2, paramInt);
        }
        k = null;
        return (IScene)var6;
    }
                ...
                if (str == "obj")
                {
                    ...
                    while (0 < _resourceSectionSize)
                    {
                        ...
                        if (str1 == "layout")
                        {
                            byte b;
                            ReadInt32(dataStream.BaseStream);
                            PuzzleScene.layoutType = ReadInt32(dataStream.BaseStream);
                            switch (PuzzleScene.layoutType)
                            {
                                case 1:
                                    PuzzleScene.width = ReadInt32(dataStream.BaseStream);
                                    PuzzleScene.height = ReadInt32(dataStream.BaseStream);
                                    for (b = 0; b < PuzzleScene.resourcePositions.Length; b++)
                                    {
                                        PuzzleScene.resourcePositions[b][0] = ReadInt32(dataStream.BaseStream);
                                        PuzzleScene.resourcePositions[b][1] = ReadInt32(dataStream.BaseStream);
                                    }
                                    for (b = 0; b < PuzzleScene.keyboardAreas.Length; b++)
                                    {
                                        PuzzleScene.keyboardAreas[b][0] = ReadInt32(dataStream.BaseStream);
                                        PuzzleScene.keyboardAreas[b][1] = ReadInt32(dataStream.BaseStream);
                                        PuzzleScene.keyboardAreas[b][2] = ReadInt32(dataStream.BaseStream);
                                        PuzzleScene.keyboardAreas[b][3] = ReadInt32(dataStream.BaseStream);
                                    }
                                    for (b = 0; b < PuzzleScene.s.Length; b++)
                                        PuzzleScene.s[b] = ReadInt32(dataStream.BaseStream);
                                    for (b = 0; b < PuzzleScene.r2.Length; b++)
                                        PuzzleScene.r2[b] = ReadInt32(dataStream.BaseStream);
                                    break;
                            }
                            continue;
                        }
                        ...
                        if (str1 == "select")
                        {
                            ...
                            a1(SelectionPuzzleScene.Read(this, dataStream));
                            continue;
                        }
                        if (str1 == "switch")
                        {
                            ...
                            a1(SwitchPuzzleScene.Read(this, dataStream));
                            continue;
                        }
                        if (str1 == "line")
                        {
                            ...
                            a1(LinePuzzleScene.Read(this, dataStream));
                            continue;
                        }
                        if (str1 == "keyboard")
                        {
                            ...
                            a1(KeyboardPuzzleScene.Read(this, dataStream));
                            continue;
                        }
                        if (str1 == "button")
                        {
