...
[ClassName("scene", "f")]
public class KeyboardPuzzleScene : PuzzleScene
{
    [MemberName("a")]
    private int a;
    [MemberName("v")]
    ...
    [FunctionName("a")]
    public static KeyboardPuzzleScene Create()
    {
        return new KeyboardPuzzleScene();
    }

    [ConstructorName("f")]
    private KeyboardPuzzleScene()
    {
    }
    ...
    {
        KeyboardPuzzleScene var3 = (KeyboardPuzzleScene)var2[0];
        z = var3.z;
        A = var3.A;
        B = var3.B;
        a = 0;
        ...
        {
            int var5;
            if ((var5 = var4[0] << 8 & '\uff00' | var4[1] & 255) <= 0x8258)
            {
    ...
    {
        KeyboardPuzzleScene var2 = Create();
