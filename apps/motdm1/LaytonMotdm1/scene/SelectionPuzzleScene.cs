...
[ClassName("scene", "q")]
public class SelectionPuzzleScene : PuzzleScene
{
    [MemberName("a")]
    ...
    [FunctionName("a")]
    public static SelectionPuzzleScene Create()
    {
        return new SelectionPuzzleScene();
    }

    [ConstructorName("q")]
    private SelectionPuzzleScene()
    {
    }
    ...
    {
        SelectionPuzzleScene var3 = (SelectionPuzzleScene)var2[0];
    ...
    {
        SelectionPuzzleScene var2 = Create();
