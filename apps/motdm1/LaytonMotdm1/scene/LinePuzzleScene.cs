...
[ClassName("scene", "k")]
public class LinePuzzleScene : PuzzleScene
{
    [MemberName("a")]
    ...
    [FunctionName("a")]
    public static LinePuzzleScene Create()
    {
        return new LinePuzzleScene();
    }

    [ConstructorName("k")]
    private LinePuzzleScene()
    {
    }
    ...
    {
        LinePuzzleScene var3 = (LinePuzzleScene)var2[0];
        E = var3.E;
        F = var3.F;
        G = var3.G;
        H = var3.H;
