...
[ClassName("scene", "l")]
public class SwitchPuzzleScene : PuzzleScene
{
    [MemberName("a")]
    ...
    [FunctionName("a")]
    public static SwitchPuzzleScene Create()
    {
        return new SwitchPuzzleScene();
    }

    [ConstructorName("l")]
    private SwitchPuzzleScene()
    {
    }
    ...
    {
        SwitchPuzzleScene var3 = (SwitchPuzzleScene)var2[0];
        C = var3.C;
        D = var3.D;
        E = var3.E;
        F = var3.F;
