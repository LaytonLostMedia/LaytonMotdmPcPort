...
using LaytonMotdm1.nazo;

namespace LaytonMotdm1.scene;

[ClassName("scene", "r")]
public abstract class PuzzleScene : IScene
{
    [MemberName("b")]
    ...
    [MemberName("g")]
    public PuzzleManager g;

    [MemberName("a")]
    private PuzzleManager a;
    [MemberName("v")]
    private PuzzleFactory[] v = null;
    [MemberName("w")]
    private int w;
    [MemberName("x")]
    private PuzzleFactory x = null;
    [MemberName("y")]
    private int y;
    [MemberName("z")]
    private int z;
    ...
    private int I;
    [MemberName("J")]
    private PuzzleFactory J = null;
    [MemberName("K")]
    private PuzzleFactory[] K = null;
    [MemberName("L")]
    private PuzzleFactory L = null;
    [MemberName("M")]
    private PuzzleFactory M;
    [MemberName("N")]
    private PuzzleFactory N;
    [MemberName("O")]
    private PuzzleFactory O;
    [MemberName("P")]
    private PuzzleFactory P;
    [MemberName("Q")]
    private PuzzleFactory Q;
    [MemberName("R")]
    private PuzzleFactory R;
    [MemberName("S")]
    private int S;
    ...
    private int Y;
    [MemberName("Z")]
    private JavaString _puzzleTitle = "";
    [MemberName("aa")]
    private JavaString _puzzleText = "";
    [MemberName("ab")]
    private JavaString[] _hintTexts = new JavaString[] { "", "", "" };
    [MemberName("ac")]
    private JavaString[] _puzzleResponses = new JavaString[] { "", "" };
    [MemberName("ad")]
    ...
    [FunctionName("a")]
    protected JavaString a1(GameContext var1, PuzzleFactory var2)
    {
        JavaString var3 = "";
    ...
    [FunctionName("b")]
    protected JavaString b1(GameContext var1, PuzzleFactory var2)
    {
        JavaString var3 = "";
        if (var1.IsKeyPressed(Display.KEY_MAIN))
        {
    ...
    [ConstructorName("r")]
    protected PuzzleScene()
    {
    }

    [FunctionName("a")]
    public void a1(PuzzleManager var1, PuzzleManager var2, int var3)
    {
        a = var1;
        g = var2;
        F = var3;
    ...
    public void Setup(GameContext gameContext)
    {
        ...
        v = new PuzzleFactory[g._objectCount - var3];
        w = 0;

        int var4;
        for (var4 = var3; var4 < g._objectCount; ++var4)
        {
            v[var4 - var3] = (PuzzleFactory)g._objects[var4];
        }
    ...
    public void Reset(GameContext var1)
    {
        ...
        {
            _puzzleResponses = new JavaString[2];
            _puzzleResponses[0] = "";
            _puzzleResponses[1] = "";
        }
    ...
    public bool Update(GameContext var1)
    {
        ...
        switch (G)
        {
            case 0:
                ...
                {
                    O.g1();
                    ((KeyboardResource)J.a1(J.e - 1).k[3]).SetInput(GetPikarat().ToString());
                    ((KeyboardResource)J.a1(J.e - 1).k[4]).a1(_hintCoins);
                }
                else if (J.c1())
                {
                    if (J.a2 == 1)
                    {
                        var3 = J.a1(1);
                        if (0 < _failCount && _failCount < _pikaratAmounts.Length)
                        {
                            if (GetPikarat() < _pikarat)
                            {
                                if (_pikaratAmounts[_failCount - 1] == _pikarat)
                                {
                                    AudioManager.PlaySound(1, n[3], 100);
                                    D = 2;
                                }
                           ...
                           ((KeyboardResource)var3.k[1]).SetInput(_pikarat.ToString());
                        }
                        else
                        {
                            ((KeyboardResource)var3.k[1]).SetInput(GetPikarat().ToString());
                        }

                        if (var1.IsKeyPressed(1048576) && (_pikarat == GetPikarat() || _pikarat == 0))
                        {
                            var3.y = 1;
                            l = _failCount;
                            AudioManager.StopSound(1);
                            AudioManager.a1(0, n[0], 100);
                        }
                    }

                    if (var2._transitionState == 0)
                    {
                        if (var1.IsKeyPressed(1048576) && !t[0].d())
                        {
                            if (am)
                            {
                                AudioManager.PlaySound(1, n[1], 100);
                ...
                else if (_isSolved && J.a2 == J.e - 1 && W)
                {
                    var3 = null;
                    AudioManager.a1(0, n[0], 100);
                    W = false;
                ...
                else
                {
                    ...
                    if (!var6.Equals(""))
                    {
                        ...
                        else if (var6.Equals("question"))
                        {
                            ...
                            J.a2 = J.e - 1;
                            am = true;
                            ((KeyboardResource)J.a1(J.a2).k[4]).a1(_hintCoins);
                            J.f1();
                            var2.ExecuteTransition(0);
                            ao = 1;
                        }
            ...
            case 3:
                if (var2._transitionState != 1)
                {
                    ...
                    else if (var2._transitionState != 3 && !(var6 = a1(var1, P)).Equals(""))
                    {
                        if (var6.Equals("yes"))
                        {
                            AudioManager.PlaySound(1, n[1], 100);
                ...
                if (var2._transitionState != 1)
                {
                    if (var2._transitionState == 2)
                    {
                        ...
                        if (a1(0))
                        {
                            if (U == 0)
                            {
                                AudioManager.PlaySound(1, n[b1(11, 3)], 100);
                            }
                            else
                            {
                                AudioManager.PlaySound(1, n[b1(20, 3)], 100);
                            }
                        }
                        ...
                        if (a1(1))
                        {
                            AudioManager.PlaySound(3, n[4], 100);
                        }
                        ...
                        if (a1(5))
                        {
                            if (y == 0)
                            {
                                AudioManager.PlaySound(1, n[5], 100);
                            }
                            else if (y == 1)
                            {
                                AudioManager.PlaySound(1, n[6], 100);
                            }
                        }
                        ...
                        if (a1(4))
                        {
                            if (y == 0)
                            {
                                if (U == 0)
                                {
                                    AudioManager.PlaySound(2, n[b1(14, 3)], 100);
                                }
                                else
                                {
                                    AudioManager.PlaySound(2, n[b1(23, 3)], 100);
                                }
                            }
                            else if (y == 1)
                            {
                                if (U == 0)
                                {
                                    AudioManager.PlaySound(2, n[b1(17, 3)], 100);
                                }
                                else
                                {
                                    AudioManager.PlaySound(2, n[b1(26, 3)], 100);
                                }
                            }
                        }

                        if (a1(6) && (_isSolved || y != 0))
                        {
                            AudioManager.a1(0, n[0], 100);
                        }
                        ...
                        if (a1(2))
                        {
                            ...
                            if (y == 0)
                            {
                                ((KeyboardResource)K[y].a1(K[y].e - 2).k[3]).SetInput(_hintCoins.ToString());
                            }
                    ...
                    else if (var2._transitionState != 3)
                    {
                        ...
                        if (y == 0)
                        {
                            ((KeyboardResource)(var3 = K[y].a1(K[y].e - 4)).k[1]).SetInput(GetPikarat().ToString());
                            ((KeyboardResource)var3.k[2]).SetInput(Y.ToString());
                            _pikarat = 0;
                        }
                    }
                }
            ...
            case 5:
                ...
                if (K[y].c1())
                {
                    if (y == 0)
                    {
                        if (K[y].a2 == K[y].e - 4)
                        {
                            if (_pikarat <= GetPikarat())
                            {
                                ((KeyboardResource)(var3 = K[y].a1(K[y].e - 4)).k[1]).SetInput((GetPikarat() - _pikarat).ToString());
                                ((KeyboardResource)var3.k[2]).SetInput((Y + _pikarat).ToString());
                                if (_pikarat == 0)
                                {
                                    AudioManager.PlaySound(2, n[3], 100);
                                }
                            ...
                            if (var1.IsKeyPressed(1048576) && GetPikarat() - _pikarat == 0)
                            {
                                AudioManager.StopSound(2);
                                if (!_isSolved && y == 0)
                                {
                        ...
                        else if (var1.IsKeyPressed(1048576) && !t[1 + y].d())
                        {
                            M.b1();
                            M.f1();
                            b1(6);
                    ...
                    else if (var1.IsKeyPressed(1048576) && !t[1 + y].d())
                    {
                        ...
                        if (!_isSolved)
                        {
                            ((KeyboardResource)J.a1(1).k[1]).SetInput(GetPikarat().ToString());
                            ++_failCount;
                            if (_failCount >= _pikaratAmounts.Length)
                            {
                                _failCount = _pikaratAmounts.Length - 1;
                            }
                        }
                    }
                }
            ...
            case 8:
                if (var2._transitionState != 1)
                {
                    ...
                    else if (var2._transitionState != 3 && !(var6 = a1(var1, N)).Equals(""))
                    {
            ...
            case 12:
                ...
                else
                {
                    if (var6.Equals("yes"))
                    {
                        AudioManager.PlaySound(1, n[29], 100);
                        ++_hintCount;
                        --_hintCoins;
                        b1(var1, false);
                    }
    ...
    {
        _puzzleTitle = g._stringValues[0];
        _puzzleText = g._stringValues[1];
        _hintTexts[0] = g._stringValues[2];
        _hintTexts[1] = g._stringValues[3];
        _hintTexts[2] = g._stringValues[4];
        _puzzleResponses[0] = g._stringValues[5];
        _puzzleResponses[1] = g._stringValues[6];
    }
    ...
    private void k1()
    {
        ...
        N = (PuzzleFactory)a._objects[0];
        N.a1(f);
        O = (PuzzleFactory)a._objects[1];
        O.a1(f);
        P = (PuzzleFactory)a._objects[2];
        P.a1(f);
        ...
        var2[0] = TextResource.Create(_puzzleTitle);
        ...
        M = (PuzzleFactory)a._objects[3];
        M.a1(f);
        L = (PuzzleFactory)a._objects[S];
        R = (PuzzleFactory)a._objects[8];
        R.a1(f);
    }
    ...
    private void b1(ScreenResource var1)
    {
        ...
        var3[2] = TextResource.Create("ナゾ " + Helper.ConvertStringDigitsWide(var2) + "  " + _puzzleTitle);
        var3[2].SetPosition(resourcePositions[3][0], resourcePositions[3][1]);
        ((TextResource)var3[2]).SetAnchorType(ResourceBase.ANCHOR_CENTER);
        J.a1(var3, 30, 2, 0, 0);
        ...
        ((KeyboardResource)var3[1]).SetAnchorType(ResourceBase.ANCHOR_RIGHT);
        ...
        ((KeyboardResource)var3[2]).SetAnchorType(ResourceBase.ANCHOR_RIGHT);
        ...
        ((KeyboardResource)var3[2]).SetAnchorType(2);
        ...
        ((KeyboardResource)var3[3]).SetAnchorType(2);
        var3[3].SetPosition(resourcePositions[9][0], resourcePositions[9][1]);
        var3[4] = c1(0);
        ((KeyboardResource)var3[4]).SetAnchorType(2);
    ...
    {
        K = new PuzzleFactory[2];
        K[0] = (PuzzleFactory)a._objects[4 + 2 * U];
        K[1] = (PuzzleFactory)a._objects[5 + 2 * U];
        ...
        for (int var2 = 0; var2 < 2; ++var2)
        {
            ...
            {
                PuzzleResource var4 = K[var2].a1(var3);
            ...
            if (var2 == 0)
            {
                ...
                ((KeyboardResource)var6[1]).SetAnchorType(2);
                ...
                ((KeyboardResource)var6[2]).SetAnchorType(2);
            ...
            if (var2 != 0)
            {
                ...
                t[2] = ScriptTextResource.Create(_puzzleResponses[1]);
                var6[1] = t[2];
            ...
            else
            {
                ...
                t[1] = ScriptTextResource.Create(_puzzleResponses[0]);
                var6[1] = t[1];
                ...
                var6[3] = c1(2);
                ((KeyboardResource)var6[3]).SetAnchorType(2);
    ...
    [FunctionName("c")]
    private static JavaString c1(GameContext var0, PuzzleFactory var1)
    {
    ...
    private void b1(GameContext var1, bool var2)
    {
        ...
        var11[0].SetAnchorType(2);
        var11[0].SetPosition(s[19], s[20]);
        var11[1] = c1(1);
        var11[1].SetAnchorType(2);
