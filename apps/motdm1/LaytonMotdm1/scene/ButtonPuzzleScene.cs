...
[ClassName("scene", "b")]
public class ButtonPuzzleScene : PuzzleScene
{
    [MemberName("v")]
    private static ButtonPuzzleScene Instance = null;
    [MemberName("w")]
    ...
    [FunctionName("a")]
    public static ButtonPuzzleScene GetInstance()
    {
        if (Instance == null)
        {
            Instance = new ButtonPuzzleScene();
        }
