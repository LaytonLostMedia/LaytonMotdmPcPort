...
using LaytonMotdm5.scene;

namespace LaytonMotdm5.nazo;
        ...
        switch (_state)
        {
            case 2:
                ...
                else if (y == -1)
                {
                    for (var2 = 0; var2 <= k.Length - 1; ++var2)
                    {
                        if (this.k[var2].posY == ControlScene.resourcePositions[7][1] && this.k[var2].posX == ControlScene.resourcePositions[7][0])
                        {
                            ((ScriptTextResource)this.k[var2]).Reset();
                        }
                        else
                        {
                ...
                else if (y == -2)
                {
                    ...
                    {
                        for (var2 = 0; var2 <= this.k.Length - 1; ++var2)
                        {
                            this.k[var2].SetIsVisible(true);
                        }
