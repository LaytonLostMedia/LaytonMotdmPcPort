...
public class TitleScene : IScene
{
    ...
    public void Setup(GameContext GameContext)
    {
        ...
        else
        {
            ...
            _resources[10].ExecuteTransition(0);
            _resources[11].ExecuteTransition(0);
            ...
            for (var ii = 0; ii < 5; ++ii)
            {
                ...
                _resources[ii * 2].ExecuteTransition(0);
            }
        ...
        switch (_state)
        {
            ...
            case 5:
                if (_animationStep == 0)
                {
                    ...
                    if (_frameCount > 20)
                    {
                        AudioManager.a1(0, this._fileManager.GetLoadedSound("bg_001.mld"), 100, 0);
                        _frameCount = 0;
                        _animationStep = 1;
                ...
                if (_animationStep == 7)
                {
                    _presenterResource.SetIsVisible(false);
                    _resources[16].SetIsVisible(true);
                    if(!_resources[17].IsVisible())
                    {
                        _resources[17].SetIsVisible(true);
                        _resources[17].ExecuteTransition(1);
                    }
                    if(!_resources[19].IsVisible())
                    {
                        _resources[19].SetIsVisible(true);
                        _resources[19].ExecuteTransition(1);
                    }
                    if(!_resources[21].IsVisible())
                    {
                        _resources[21].SetIsVisible(true);
                        _resources[21].ExecuteTransition(1);
                    }
                    if (_loadDifferentFont&&!_resources[20].IsVisible())
                    {
                        _resources[20].SetIsVisible(true);
                        _resources[20].ExecuteTransition(1);
                    }
                    ...
                    {
                        if (!_resources[0 + var7 * 2].IsVisible())
                        {
                            _resources[0 + var7 * 2].SetIsVisible(true);
                            _resources[0 + var7 * 2].ExecuteTransition(1);
                        }
                    }

                    if(!_resources[10].IsVisible())
                    {
                        _resources[10].SetIsVisible(true);
                        _resources[11].SetIsVisible(true);
                        _resources[10].ExecuteTransition(1);
                        _resources[11].ExecuteTransition(1);
                    }
                    _resources[18].SetIsVisible(false);
                    _state = 0;
                    _animationStep = 0;
