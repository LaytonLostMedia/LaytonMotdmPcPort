        ...
        switch (a)
        {
            ...
            case 99:
                if (var2._transitionState == 2)
                {
                    ...
                    {
                        case 0:
                            gameContext.SetCurrentScene(scene.IngameMenuScene.GetInstance());
                            break;
                        case 1:
                            gameContext.RoomData.SetEventId(256);
                            gameContext.SetCurrentScene(scene.EventScene.GetInstance());
                            break;
                        default:
                            gameContext.SetCurrentScene(scene.IngameMenuScene.GetInstance());
                            break;
