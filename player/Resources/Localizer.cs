...
namespace DoCoMoPlayer.Resources
{
    ...
    {
        private const string LANG_FOLDER = "resources\\localizations";
        ...
        public string Localize(string name, params object[] args)
        {
            ...
            if (!string.IsNullOrEmpty(DEFAULT_LOCALE) && _localizations.ContainsKey(DEFAULT_LOCALE) && _localizations[DEFAULT_LOCALE].ContainsKey(name))
